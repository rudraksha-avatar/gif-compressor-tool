export const toolsDirectoryHtml = `
  <div class="card">
    <div class="card-header">
      <h2><i class="fa-solid fa-toolbox" aria-hidden="true"></i> Available Tools</h2>
      <p>Private browser-based tools for compressing, converting, and optimizing GIF files.</p>
    </div>
    <div class="tools-grid">

      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-regular fa-file-image" aria-hidden="true"></i></div>
        <h3>GIF Compressor</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-film" aria-hidden="true"></i></div>
        <h3>MP4 to GIF Converter</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-video" aria-hidden="true"></i></div>
        <h3>GIF to MP4 Converter</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-up-right-and-down-left-from-center" aria-hidden="true"></i></div>
        <h3>GIF Resizer</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-crop-simple" aria-hidden="true"></i></div>
        <h3>GIF Cropper</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-gauge-high" aria-hidden="true"></i></div>
        <h3>GIF Speed Changer</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-regular fa-images" aria-hidden="true"></i></div>
        <h3>GIF Frame Splitter</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-wand-magic-sparkles" aria-hidden="true"></i></div>
        <h3>GIF Maker</h3>
      ...
      <div class="tool-card">
        <div class="tool-card-icon"><i class="fa-solid fa-sliders" aria-hidden="true"></i></div>
        <h3>Advanced GIF Optimizer</h3>
